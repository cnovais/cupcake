...
const Admin = () => {
  ...
  const handleAdminLogin = (e) => {
    ...
    if (username === 'admin' && password === 'cleitonbonitao') {
  ...
  const handleClearInconsistentData = async () => {
    if (window.confirm('⚠️ Isso irá remover usuários do LocalStorage que não existem no Airtable. Continuar?')) {
      try {
        await clearInconsistentData();
        await loadData(); // Recarregar dados
        alert('Dados inconsistentes removidos com sucesso!');
      } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">
                Gerenciar usuários cadastrados na Lumière cupcakes
              </p>
            </div>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600">Status de Login</p>
                  <p className="text-2xl font-semibold text-gray-900">
                    {stats.isLoggedIn ? 'Logado' : 'Deslogado'}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-lg font-semibold text-gray-900">
                    {stats.currentUserId ? 'ID: ' + stats.currentUserId : 'Nenhum'}
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-8">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <button
              onClick={handleClearInconsistentData}
              className="inline-flex items-center px-4 py-2 border border-orange-300 text-sm font-medium rounded-lg text-orange-700 bg-orange-50 hover:bg-orange-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500"
            >
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">

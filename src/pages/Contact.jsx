      ...
      <section className="bg-gradient-to-r from-primary-500 to-pink-400 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-primary-100 max-w-3xl mx-auto">
            Estamos aqui para ajudar você a criar o cupcake perfeito!
          </p>
        </div>
      </section>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">(11) 4799-3370</p>
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="mt-6 p-4 bg-primary-50 rounded-lg">
                ...
                <p className="text-gray-600 text-sm">
                  Estamos localizados no centro de Mogi das Cruzes, próximo à praça principal. 
                  Há estacionamento disponível na rua e nas proximidades.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary-500 to-pink-400 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-100 mb-8 max-w-3xl mx-auto">
            Entre em contato conosco agora mesmo e vamos criar o cupcake perfeito para você!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={handleWhatsAppClick}
              className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-lg font-medium rounded-lg text-primary-600 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white transition-colors"
            >
